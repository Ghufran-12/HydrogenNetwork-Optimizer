...
export default function TargetsPage() {
  ...
  async function loadTargets() {
    ...
    setApiError("");
    try {
      const res  = await authFetch("https://hydrogennetwork-optimizer-1.onrender.com/targets/team");
  ...
  async function handleAdd() {
    ...
    setSaving(true);
    try {
      const res  = await authFetch("https://hydrogennetwork-optimizer-1.onrender.com/targets/create", {
        method: "POST",
        body: JSON.stringify({
          metric:     form.metric,
          goal_value: goalNum,
  ...
  async function handleDelete(id) {
    ...
    try {
      const res  = await authFetch(`https://hydrogennetwork-optimizer-1.onrender.com/targets/${id}`, { method: "DELETE" });
      const data = await res.json();
