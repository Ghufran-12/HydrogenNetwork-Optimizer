...
export default function SMRPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch("https://hydrogennetwork-optimizer-1.onrender.com/recommend", {
        method: "POST",
      ...
      try {
        const histRes = await authFetch(
          replaceId ? `https://hydrogennetwork-optimizer-1.onrender.com/history/${replaceId}` : "https://hydrogennetwork-optimizer-1.onrender.com/history",
          {
