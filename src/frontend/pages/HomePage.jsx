...
export default function HomePage() {
  ...
  useEffect(() => {
    authFetch("http://localhost:8000/targets/team")
      .then(r => r.json())
  ...
  useEffect(() => {
    ...
    setMgrLoading(true);
    Promise.all([
      authFetch("http://localhost:8000/manager/dashboard").then(r => r.json()),
      authFetch("http://localhost:8000/plant/baseline").then(r => r.json()),
    ])
