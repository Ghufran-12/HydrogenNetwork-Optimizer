...
export default function ResultsPage() {
  ...
  useEffect(() => {
    if (!form) return;
    fetch("https://hydrogennetwork-optimizer-1.onrender.com/sensitivity", {
      method: "POST",
  ...
  useEffect(() => {
    ...
    fetch("https://hydrogennetwork-optimizer-1.onrender.com/confidence", {
      method: "POST",
  ...
  const handleSendEmail = async () => {
    ...
    try {
      const res = await fetch("https://hydrogennetwork-optimizer-1.onrender.com/send-report", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
